...
sections:
  - type: GenericSection
    ...
    actions:
      ...
      - label: See Tutorials
        ...
        type: Link
    media:
      url: /images/Technologies (8).png
      altText: Unblock your team boost your time to production preview
      elementId: ''
      type: ImageBlock
    badge:
      label: Ever Technologies
      color: text-primary
      type: Badge
    elementId: ''
  ...
  - title:
      ...
      styles:
        self:
          textAlign: center
      type: TitleBlock
    subtitle: '"With Ever CRM the only thing you need do do is sit back and Relax"'
    text: ''
    media:
  ...
  - type: GenericSection
    title:
      text: Marketing campaign services
      color: text-dark
      styles:
        self:
          textAlign: left
  ...
  - title:
    ...
    media:
      ...
      type: ImageBlock
    badge:
      label: Roadmap and product launch
      color: text-primary
      type: Badge
    colors: bg-light-fg-dark
    styles:
